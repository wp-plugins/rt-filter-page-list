...
/*
Copyright 2014 Roy Tanck (email: roy.tanck@gmail.com.com)
	...
	class RT_Filter_Page_List {
		...
		public function __construct(){
			...
			if( class_exists('DOMDocument') ){
				// register action
				add_filter( 'wp_list_pages', array( &$this, 'filter_html' ) );
			} else {
		...
		function filter_html( $html ){
			...
			foreach( $pagelinks as $pagelink ){
				...
				$parentli = $this->find_parent_node( $pagelink, 'li' );
		 ...
		 */
		function find_parent_node( $n, $nodetype ){
